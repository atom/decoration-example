...
This will show you all the capabilities of Atom's Decoration API. When enabled, it adds a panel of buttons that exercise the API.
...
It's common when writing packages to annotate, or decorate lines, gutter line numbers, and highlight ranges of text. The decoration API allows you to add CSS classes and styling to these gutter line numbers, lines, and regions of text.
...
There are two ways to destroy a decoration. If you own the marker and will no longer need it, you can destroy the marker, and the decoration will be destroyed:
